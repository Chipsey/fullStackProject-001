        ...
        className={this.props.mode}>
            <div className="login--home">
                ...
                <div className="login--content">
                    ...
                    <div>
                        <img src="appstore.png" alt="appStore--icon" width="40px" className="login-store--logo"></img>
                            <img src="playstore.png" alt="playStore--icon" width="20px" className="login-store--logo"></img>
                    </div>
                    <p className="login-mobile--content">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat, eius recusandae.</p>

                    <div><button className="login-button--gs">DOWNLOAD</button></div>
                </div>
